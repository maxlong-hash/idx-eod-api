      ...
      schemas: {
        ...
        ScreenerMaxRecord: {
          ...
          properties: {
            ...
            signalAgeLabel: { type: ['string', 'null'] },
            ageDays: { type: ['number', 'null'] },
            trend: { type: ['string', 'null'] },
            trendShort: { type: ['string', 'null'], enum: ['BULLISH', 'BEARISH', 'NEUTRAL', 'N/A', null] },
            trendMedium: { type: ['string', 'null'], enum: ['BULLISH', 'BEARISH', 'NEUTRAL', 'N/A', null] },
            trendLong: { type: ['string', 'null'], enum: ['BULLISH', 'BEARISH', 'NEUTRAL', 'N/A', null] },
            structure: { type: ['string', 'null'] },
            regime: { type: ['string', 'null'] },
            risenScore: { type: ['number', 'null'] },
            risenInsideRolling: { type: ['string', 'null'] },
            risenRecentUpBreak: { type: ['string', 'null'] },
            risenVolSurge: { type: ['string', 'null'] },
            quadrant: { type: ['string', 'null'] },
            alphaStatus: { type: ['string', 'null'] },
            rvol: { type: ['number', 'null'] },
            volPower: { type: ['number', 'null'] },
            volRegime: { type: ['string', 'null'] },
            xrayBuyPowerPct: { type: ['number', 'null'] },
            xraySellPowerPct: { type: ['number', 'null'] },
            rsi: { type: ['number', 'null'] },
            adx: { type: ['number', 'null'] },
            plusDi: { type: ['number', 'null'] },
            minusDi: { type: ['number', 'null'] },
            ema21: { type: ['number', 'null'] },
            ema50: { type: ['number', 'null'] },
            ema200: { type: ['number', 'null'] },
            volume: { type: ['number', 'null'] },
            volumeSma20: { type: ['number', 'null'] },
            score: { type: ['number', 'null'] },
            logicNotes: { type: ['string', 'null'] },
            ...
            weight1: { type: ['number', 'null'] },
            weight2: { type: ['number', 'null'] },
            weight3: { type: ['number', 'null'] },
            weight4: { type: ['number', 'null'] },
