...
const HEADER_MAP = new Map([
  ...
  ['Structure', 'structure'],
  ['Regime', 'regime'],
  ['RisenScore', 'risenScore'],
  ['RisenInsideRolling', 'risenInsideRolling'],
  ['RisenRecentUpBreak', 'risenRecentUpBreak'],
  ['RisenVolSurge', 'risenVolSurge'],
  ['Quadrant', 'quadrant'],
  ['AlphaStatus', 'alphaStatus'],
  ['RVol', 'rvol'],
  ['VolPower', 'volPower'],
  ['VolRegime', 'volRegime'],
  ['XRayBuyPowerPct', 'xrayBuyPowerPct'],
  ['XRaySellPowerPct', 'xraySellPowerPct'],
  ['RSI', 'rsi'],
  ['ADX', 'adx'],
  ['PlusDI', 'plusDi'],
  ['MinusDI', 'minusDi'],
  ...
  ['UpsideBuy1Pct', 'upsideBuy1Pct'],
  ['UpsideAvgPct', 'upsideAvgPct'],
